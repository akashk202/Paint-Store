...
class _PersonalInfoPageState extends ConsumerState<PersonalInfoPage>
  ...
  Future<void> _loadUserInfo() async {
    try {
      ...
      // Handled by view model error state
    } finally {
  ...
  Future<void> _saveChanges() async {
    ...
    try {
      ...
      if (_selectedImage != null) {
        await vm.updateProfilePicture(_selectedImage!);
  ...
  Future<void> _deleteProfilePicture() async {
    try {
      await ref.read(userNotifierProvider.notifier).deleteProfilePicture();
  ...
  void _showAvatarOptions(String? currentPhotoUrl) {
  ...
  Widget build(BuildContext context) {
    ...
    final isLoading = _isInitializing || userState.loading;
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SlideTransition(
                                ...
                                child: _buildProfileAvatar(profile?.photoUrl)),
  ...
  Widget _buildProfileAvatar(String? photoUrl) {
    return Stack(
      ...
      children: [
        ...
        GestureDetector(
          onTap: () => _showAvatarOptions(photoUrl),
