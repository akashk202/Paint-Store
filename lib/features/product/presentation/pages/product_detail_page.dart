...
class _ProductDetailPageState extends ConsumerState<ProductDetailPage> {
  ...
  // Function to add the selected size product to the user's cart via Notifier
                  ...
                  if (_selectedPack != null && _selectedPack!.price.isNotEmpty)
                    Row(
                      children: [
                        ...
                        Text('ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¹${_selectedPack!.price}',
                            style: GoogleFonts.poppins(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            showPrice ? 'MRP ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¹$price' : 'MRP ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â',
            style: GoogleFonts.poppins(
              fontSize: 12,
