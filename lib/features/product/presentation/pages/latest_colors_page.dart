...
class LatestColorsPage extends ConsumerStatefulWidget {
  const LatestColorsPage({super.key});

  @override
  ConsumerState<LatestColorsPage> createState() => _LatestColorsPageState();
}
          ...
          return GridView.builder(
            ...
            itemBuilder: (context, i) {
              ...
              return GestureDetector(
                onTap: () async {
                  if (code.isEmpty) {
                    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                        content: Text('Shade code missing for this color')));
                    return;
                  }
                  try {
                ...
                child: _ShadeCard(
                    name: name, code: code, hex: hex, color: color),
              );
            },
          );
        },
