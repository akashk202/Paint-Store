...
class _VisualizerPageState extends ConsumerState<VisualizerPage> {
  ...
  Future<void> _pickFromGallery() async {
    try {
      ...
      if (img != null) {
        ...
        ref.read(visualizerNotifierProvider.notifier).clearResult();
      }
    } catch (e) {
      if (!mounted) return;
  ...
  void _openColorPicker() async {
    final vm = ref.read(visualizerNotifierProvider.notifier);
    final current = ref.read(visualizerNotifierProvider).color;
    Color temp = current;
    await showDialog(
      context: context,
  ...
  Widget build(BuildContext context) {
    final vmState = ref.watch(visualizerNotifierProvider);
