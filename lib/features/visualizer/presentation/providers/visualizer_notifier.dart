...
class VisualizerNotifier extends StateNotifier<VisualizerState> {
  final VisualizeImage _visualizeImage;

  VisualizerNotifier({required VisualizeImage visualizeImage})
      : _visualizeImage = visualizeImage,
        super(VisualizerState.initial());
