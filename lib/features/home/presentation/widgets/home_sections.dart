    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        _buildContactInfoItem(
          Iconsax.location,
          "Ã°Å¸â€œÂ Location: Kuttikkattupadi, Kerala",
          onTap: () =>
              _launchUrlHelper("https://maps.app.goo.gl/YsqSXgvtwZmEzuSH6"),
        ),
        _buildContactInfoItem(Iconsax.call, "Ã°Å¸â€œÅ¾ Phone: +91 9744345394"),
        _buildContactInfoItem(
            Iconsax.sms, "Ã¢Å“â€° Email: chandrapaints2025@gmail.com"),
        const SizedBox(height: 16),
        Text("Business Hours:",
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(children: [
        ...
        const SizedBox(height: 8),
        Text("Ã‚Â© ${DateTime.now().year} All Rights Reserved",
