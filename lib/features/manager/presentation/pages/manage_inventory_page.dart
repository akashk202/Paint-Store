...
import 'package:c_h_p/features/product/presentation/pages/edit_product_page.dart';import 'package:firebase_database/firebase_database.dart';
...
class _ManageInventoryPageState extends State<ManageInventoryPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        // Ã¢Â­Â RENAMED: Title is now more specific
      ...
      // Ã¢Â­Â UPDATED: FAB now only has one purpose
