        ...
        builder: (context, AsyncSnapshot<DatabaseEvent> snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              // â­ UI: Replaced the custom Column with a more professional ListTile inside the Card.
              return Card(
                ...
                child: Padding(
                  ...
                  child: ListTile(
                    leading: CircleAvatar(
                      ...
                      // â­ UI: Using CachedNetworkImage for better performance and placeholders.
                    ...
                    subtitle: Column(
                      ...
                      children: [
                        ...
                        Row(children: [
                          ...
                          const SizedBox(width: 6),
                          Text('â‚¹${painter.dailyFare} / day', style: GoogleFonts.poppins()),
                        ]),
                      ],
                    ),
                    isThreeLine: true,
