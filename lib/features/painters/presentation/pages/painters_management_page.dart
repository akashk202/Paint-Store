import 'dart:io';
import 'package:cached_network_image/cached_network_image.dart'; // â­ OPTIMIZATION: Import new package
        ...
        return StatefulBuilder(
          builder: (BuildContext context, StateSetter setModalState) {
            ...
            Future<void> pickImage() async {
              // â­ OPTIMIZATION: Resize image on pick to prevent freezing
            ...
            itemBuilder: (context, index) {
              ...
              return Dismissible(
                ...
                child: Card(
                  ...
                  child: ListTile(
                    // â­ OPTIMIZATION: Use CachedNetworkImage for smooth scrolling
