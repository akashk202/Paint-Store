import 'package:c_h_p/features/product/data/models/product_model.dart';import '../../domain/entities/explore_product_entity.dart';

class ExploreProductModel extends ExploreProductEntity {
  ...
  factory ExploreProductModel.fromProduct(Product product) {
  ...
  factory ExploreProductModel.fromEntity(ExploreProductEntity entity) {
    return ExploreProductModel(
      key: entity.key,
      name: entity.name,
