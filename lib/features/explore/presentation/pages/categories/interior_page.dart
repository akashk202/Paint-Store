...
class InteriorPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
// â­ UI: Added a subtle gradient background for a less bland look
...
// â­ UI: Centered the cards vertically on the page
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(
                  height: 20), // â­ UI: Increased spacing between cards
  ...
  Widget build(BuildContext context) {
    return MouseRegion(
      ...
      child: AnimatedScale(
        ...
        child: Card(
          margin: EdgeInsets.zero, // â­ UI: Removed default card margin
          ...
          child: InkWell(
            onTap: widget.onTap,
            child: Container(
              height: 150, // â­ UI: Increased card height
              ...
              child: Center(
// â­ UI: Added padding around the logo inside the card
