...
class LuxuryPage extends ConsumerStatefulWidget {
  const LuxuryPage({super.key});

  @override
  ConsumerState<LuxuryPage> createState() => _LuxuryPageState();
}

class _LuxuryPageState extends ConsumerState<LuxuryPage> {
  @override
  void initState() {
    super.initState();
